...
class PrivacyController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.cms.privacy', compact('privacy'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return response()->json(['status' => 'success', 'message' => 'Privacy Policy updated successfully']);
    }
