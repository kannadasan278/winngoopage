 ...
 protected $permissionService;
    ...
    public function create()
    {
        ...
        foreach ($permission_groups as $group){
                    $permissions = $this->permissionService->checkPermissionByGroup($group->name);

        }
        return view('backend.roles.create', compact('all_permissions', 'permission_groups','permissions'));
    }
    ...
    public function update(Request $request, int $id)
    {
        ...
        if ($id === 1) {
            Alert::success('error', 'Sorry !! You are not authorized to edit this role !');
