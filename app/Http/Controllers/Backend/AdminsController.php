   ...
   public function store(Request $request)
    {
        ...
        return response()->json(['success' => 'Staff created successfully.']);
    }
    ...
    {
        if (is_null($this->user) || !$this->user->can('staff.edit')) {
     ...
     public function update(Request $request, int $id)
    {
        ...
        if (is_null($this->user) || !$this->user->can('staff.edit')) {
            abort(403, 'Sorry !! You are Unauthorized to edit any admin !');
               ...
               if ($id === 1) {
                Alert::success('error', 'Sorry !! You are not authorized to update this Admin as this is the Super Admin. Please create new one if you need to test !');
    ...
    {
        if (is_null($this->user) || !$this->user->can('staff.delete')) {
        ...
        if (!is_null($admin)) {
            $admin->delete();
                   ...
                   Alert::success('Success', 'Staff has been deleted !!');
