                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-6 d-flex mb-4 mb-md-0 form-area">
                            <div class="logo">
                                <a href="{{ route('home') }}" title=""><img src="{{asset('customer/assets/images/new/logo-white.svg')}}" alt="Logo"></a>
                            </div>

                            <div class="flex-box-3 login form-section">
                                <h2>Customer Login</h2>
                                <p class="signup">Don't have an account? <a href="{{route('register.form')}}">Signup</a></p>
                            ...
                            <div id="alert" class="alert alert-danger bg-danger text-white mb-0" style="display: none;"></div>
                                ...
                                @endif
                                    <form id="loginForm" method="post" data-email-exists-url="{{ route('check.email.exists') }}">
                                        @csrf
                                        ...
                                        <div class="login_footer form-group mb-50">
                                                ...
                                                <a class="text-muted" href="{{ route('password.reset') }}">Forgot password?</a>
                                            </div>
