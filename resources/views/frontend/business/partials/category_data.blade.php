                    ...
                    <div class="shop-product-fillter">
                        <div class="totall-product">
                            <p>We found <strong class="text-brand">{{ count($merchants) }}</strong> items for <span style="text-transform: capitalize">@if($category->category_name_en){{ $category->category_name_en }}@endif</span> <span style="text-transform: capitalize">@if($category->subcategory_name_en){{ $category->subcategory_name_en }}@endif</span> you!</p>
                        </div>
