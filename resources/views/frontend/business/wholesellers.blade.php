            ...
            <div class="container">
                <div class="archive-header">
                    <div class="row align-items-center">
                        <div class="col-xl-3">
                            <h1 class="mb-15">Wholesellers</h1>
                            <div class="breadcrumb">
                                <a href='{{ route('home') }}' rel='nofollow'><i class="fi-rs-home mr-5"></i>Home</a>
                                <span></span> wholesellers <span></span>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-4-5">
                         @if($merchants->isEmpty())
                                <p style="text-align: center;">No wholesellers found for this.</p>
                            @else
                        @include('frontend.business.partials.wholesalers')
