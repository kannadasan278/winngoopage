                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="bannerForm" action="{{ route('admin.banners.update', $banner->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="title" id="title" class="form-control" value="{{ $banner->title }}" placeholder="Enter title" required>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <br>
                                            <img src="{{ asset($banner->image_path) }}" width="100" height="100" alt="Banner Image">
                                        </div>
                                        <div class="mb-3">
                                ...
                                <br>
                                <button type="submit" id="bannerBtn" class="btn btn-primary">Update</button>
                            </form>
                        </div>
                    </div>
                </div>
            ...
            $.ajax({
                ...
                error: function(xhr, status, error) {
                    Swal.fire({
                        icon: 'error',
                        title: 'Error',
                        text: 'Failed to update banner: ' + error,
                    });
                }
            });
        }
