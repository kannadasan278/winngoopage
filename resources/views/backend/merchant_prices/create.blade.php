        ...
        <div class="container-fluid">
                ...
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <div class="page-title">
                            <h4 class="mb-0 font-size-18">Create Merchant Price</h4>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Create Merchant Price</h4>

                             @include('backend.merchant_prices._form', ['route' => route('admin.merchant-prices.store'), 'method' => 'POST'])
