        ...
        <div class="container-fluid">
                ...
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <div class="page-title">
                            <h4 class="mb-0 font-size-18">Update Sub-SubCategory</h4>
                            <a href="{{ route('admin.subsubcategories.index') }}"
                                class="btn btn-danger waves-effect waves-light float-right" style="float: right;margin-top: 10px;margin-left: 1400px;">Back List Sub-SubCategory</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Update SubSubCategory</h4>

                            <form id="subsubcategoryForm" action="{{ route('admin.subsubcategories.update', $subsubCategory) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="subsubcategory_name_en" name="subsubcategory_name_en" placeholder="Enter Name" oninput="handleCreateSlug(this)" value="{{ old('subsubcategory_name_en', $subsubCategory->subsubcategory_name_en) }}">
                                            <input type="hidden" class="form-control" id="subsubcategory_slug_en" name="subsubcategory_slug_en" oninput="handleCreateSlug(this)" value="{{ old('subsubcategory_slug_en', $subsubCategory->subsubcategory_slug_en) }}">
                    ...
                    success: function (response) {
                        if (response.status == 'success') {
                            Swal.fire({
                                icon: 'success',
                                title: 'Success',
                                text: 'SubSubcategory updated successfully!',
                            }).then(() => {
                                form.reset();
