                ...
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <div class="page-title">
                            <h4 class="mb-0 font-size-18">Create SubCategory</h4>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="subcategory_name_en" name="subcategory_name_en" placeholder="Enter Name" oninput="handleCreateSlug(this)">
                                            <input type="hidden" class="form-control" id="subcategory_slug_en" name="subcategory_slug_en" oninput="handleCreateSlug(this)">
