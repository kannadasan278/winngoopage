                    ...
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <div class="page-title">
                            ...
                            <a href="{{ route('admin.coupons.index') }}"
                                class="btn btn-danger waves-effect waves-light float-right" style="float: right;margin-top: 10px;margin-left: 1400px;">Back to Coupon List</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            ...
                            <form id="couponForm" action="{{ route('admin.coupons.update', $coupon->id) }}" method="POST">
                                ...
                                <select name="coupon_type" id="coupon_type" class="form-control">
                                    ...
                                    <option value="fixed" {{ isset($coupon) && $coupon->coupon_type == 'fixed' ? 'selected' : '' }}>Fixed Amount</option>
                                    <option value="percentage" {{ isset($coupon) && $coupon->coupon_type == 'percentage' ? 'selected' : '' }}>Percentage</option>
                                </select>
                            </div><br>
                                <div class="form-group">
